...
import com.ctvit.base.utils.NetUtils;
    ...
    public void setStatus(int status) {
        ...
        switch (status) {
            ...
            case STATUS_LOADING:
                ...
                mImageView.setImageResource(R.drawable.list);
            ...
            case STATUS_LOAD_FAILED:
                ...
                Boolean networkConn = NetUtils.isNetworkConnected();
